...
async def resample(inBars: BarDataList, inBarHasNewBar: bool):
    ...
    """
    await resample_from_5s_core(inBars[-1], inBarHasNewBar)
    b = inBars[-1]
...
def main():
    ...
    for sym in syms:
        ...
        def initialize_bars(bars: BarDataList, barSizeSetting):
        ...
        initialize_bars(resampled, '1 min')
        initialize_bars(outBars2m, '2 mins')
        initialize_bars(outBars5m, '5 mins')
        initialize_bars(outBars10m, '10 mins')
        initialize_bars(outBars15m, '15 mins')
        initialize_bars(outBars30m, '30 mins')
