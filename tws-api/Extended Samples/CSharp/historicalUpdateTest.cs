...
{
    internal class historicalUpdateTest : DefaultEWrapper
    {
        ...
        public static void historicalUpdateMain()
        {
            var testImpl = new historicalUpdateTest();
            ...
            clientSocket.reqHistoricalData(testImpl.NextOrderId, contract, "", "1 D", "1 hour", "Trades", 1, 1, true, null);
        ...
        {
            Console.WriteLine("UPDATE || " + reqId + " - Time: " + bar.Time + ", Open: " + Util.DoubleMaxString(bar.Open) + ", High: " + Util.DoubleMaxString(bar.High) +
                ", Low: " + Util.DoubleMaxString(bar.Low) + ", Close: " + Util.DoubleMaxString(bar.Close) + ", Volume: " + Util.DecimalMaxString(bar.Volume) +
                ", Count: " + Util.IntMaxString(bar.Count) + ", WAP: " + Util.DecimalMaxString(bar.WAP));
        }

        //! [socket_init]
        public historicalUpdateTest()
        {
